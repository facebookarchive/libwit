 ...
 *
 *  Return a new allocated buffer of double, which will need to be freed later
 */
static double * wvs_pcm16short2dbfs(int16_t *samples, int size);
...
int wvs_still_talking(wvs_state *state, int16_t *samples, int nb_samples)
{
    double *dbfss;
    double db;
    int result;
